...
const Home = () => {
  return (
    <section className="py-4 pb-20 w-[85vw] mx-auto">
      <div className="grid  grid-cols-1  md:grid-cols-2 gap-8">
        <div className="hidden md:flex items-center justify-center h-[calc(100vh-73px)]">
          <div className="relative">
            <Image
              ...
              width={500}
              height={500}
              className="transition-all rounded-full hover:-translate-y-1 hover:-translate-x-1"
            />
          </div>
        </div>{" "}
        <div className="flex flex-col  items-start justify-center h-[calc(100vh-73px)] font-poppins">
          ...
          <h2 className="text-xl uppercase font-extrabold">
